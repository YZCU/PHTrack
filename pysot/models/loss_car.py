"""
This file contains specific functions for computing losses of phtrack
file
"""
...
class phtrackLossComputation(object):
    """
    This class computes the phtrack losses.
    """
    ...
    def __call__(self, locations, box_cls, box_regression, centerness, labels, reg_targets):
        ...
        Arguments:
            ...
            zf_sr (super resolution result)
            xf_sr (super resolution result)
...
def make_phtrack_loss_evaluator(cfg):
    loss_evaluator = phtrackLossComputation(cfg)
